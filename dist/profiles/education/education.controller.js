...
let EducationController = class EducationController {
    ...
    async remove(id, user) {
        ...
        if (education.userId !== user.id) {
            throw new common_1.ForbiddenException('You are not authorized to delete this education entry.');
        }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete an education entry from the current user\'s profile' }),
    (0, swagger_1.ApiResponse)({ status: 204, description: 'The education entry has been successfully deleted.' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Not Found - The education entry with the given ID does not exist.' }),
